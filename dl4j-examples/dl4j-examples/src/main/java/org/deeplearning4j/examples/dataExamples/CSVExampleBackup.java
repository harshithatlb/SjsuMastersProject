...
public class CSVExampleBackup {
    ...
    public static void main(String[] args) throws  Exception {
        ...
        int batchSize = 6188;    //Iris data set: 150 examples total. We are loading all of them into one DataSet (not recommended for large data sets)
